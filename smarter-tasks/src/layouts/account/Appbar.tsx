                      ...
                      return (
                        <Link
                          ...
                          className={classNames(
                            isCurrent
                              ? "bg-slate-50 text-blue-700 dark:bg-slate-500 dark:text-zinc-50"
          ...
          relative inline-flex h-[24px] w-[60px] shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2  focus-visible:ring-white focus-visible:ring-opacity-75`}
                ...
                pointer-events-none inline-block h-[16px] w-[16px] transform rounded-full bg-white shadow-lg ring-0 transition duration-200 ease-in-out`}
                  ...
                  <Menu as="div" className="relative ml-3">
                    <div>
                      <Menu.Button className="rounded-full bg-white p-1 text-gray-400 hover:text-blue-600 dark:bg-slate-800 dark:text-zinc-50">
                        <UserCircleIcon
                          className="h-6 w-6"
                          aria-hidden="true"
                        />
